...
import com.cyb.service.ProductOrderService;
import com.cyb.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.cyb.domain.ProductOrder}.
 */
@RestController
@RequestMapping("/api")

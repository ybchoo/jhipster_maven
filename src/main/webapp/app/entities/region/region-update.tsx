  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="tut3App.region.home.createOrEditLabel" data-cy="RegionCreateUpdateHeading">
            <Translate contentKey="tut3App.region.home.createOrEditLabel">Create or edit a Region</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('tut3App.region.regionId')}
                id="region-regionId"
                name="regionId"
                data-cy="regionId"
                type="text"
              />
              <ValidatedField
                label={translate('tut3App.region.regionName')}

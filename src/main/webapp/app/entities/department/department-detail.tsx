    ...
    <Row>
      <Col md="8">
        <h2 data-cy="departmentDetailsHeading">
          <Translate contentKey="tut3App.department.detail.title">Department</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="departmentId">
              <Translate contentKey="tut3App.department.departmentId">Department Id</Translate>
            </span>
          </dt>
          <dd>{departmentEntity.departmentId}</dd>
          <dt>
            <span id="departmentName">
              <Translate contentKey="tut3App.department.departmentName">Department Name</Translate>
            </span>
          </dt>
          <dd>{departmentEntity.departmentName}</dd>
          <dt>
            <Translate contentKey="tut3App.department.location">Location</Translate>
          </dt>

...
export const ProductCategoryDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="tut3App.productCategory.delete.question">
        <Translate contentKey="tut3App.productCategory.delete.question" interpolate={{ id: productCategoryEntity.id }}>

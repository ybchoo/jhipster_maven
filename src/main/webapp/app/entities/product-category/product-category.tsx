  ...
  return (
    <div>
      <h2 id="product-category-heading" data-cy="ProductCategoryHeading">
        <Translate contentKey="tut3App.productCategory.home.title">Product Categories</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="tut3App.productCategory.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/product-category/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="tut3App.productCategory.home.createLabel">Create new Product Category</Translate>
          </Link>
        </div>
      </h2>
      <Row>
            ...
            <FormGroup>
              <InputGroup>
                <Input
                  ...
                  placeholder={translate('tut3App.productCategory.home.search')}
                />
        ...
        {productCategoryList && productCategoryList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="tut3App.productCategory.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="tut3App.productCategory.name">Name</Translate>
                </th>
                <th>
                  <Translate contentKey="tut3App.productCategory.description">Description</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="tut3App.productCategory.home.notFound">No Product Categories found</Translate>
            </div>
          )
        )}
      </div>

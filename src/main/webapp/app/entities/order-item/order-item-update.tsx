  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="tut3App.orderItem.home.createOrEditLabel" data-cy="OrderItemCreateUpdateHeading">
            <Translate contentKey="tut3App.orderItem.home.createOrEditLabel">Create or edit a OrderItem</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('tut3App.orderItem.quantity')}
              ...
              />
              <ValidatedField
                label={translate('tut3App.orderItem.totalPrice')}
              ...
              />
              <ValidatedField
                label={translate('tut3App.orderItem.status')}
              ...
              >
                {orderItemStatusValues.map(orderItemStatus => (
                  <option value={orderItemStatus} key={orderItemStatus}>
                    {translate('tut3App.OrderItemStatus.' + orderItemStatus)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                ...
                name="product"
                data-cy="product"
                label={translate('tut3App.orderItem.product')}
                type="select"
              >
                <option value="" key="0" />
                {products
              ...
              <ValidatedField id="order-item-order" name="order" data-cy="order" label={translate('tut3App.orderItem.order')} type="select">
                <option value="" key="0" />
                {productOrders

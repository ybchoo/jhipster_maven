    ...
    <Row>
      <Col md="8">
        <h2 data-cy="orderItemDetailsHeading">
          <Translate contentKey="tut3App.orderItem.detail.title">OrderItem</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="quantity">
              <Translate contentKey="tut3App.orderItem.quantity">Quantity</Translate>
            </span>
          </dt>
          <dd>{orderItemEntity.quantity}</dd>
          <dt>
            <span id="totalPrice">
              <Translate contentKey="tut3App.orderItem.totalPrice">Total Price</Translate>
            </span>
          </dt>
          <dd>{orderItemEntity.totalPrice}</dd>
          <dt>
            <span id="status">
              <Translate contentKey="tut3App.orderItem.status">Status</Translate>
            </span>
          </dt>
          <dd>{orderItemEntity.status}</dd>
          <dt>
            <Translate contentKey="tut3App.orderItem.product">Product</Translate>
          </dt>
          <dd>{orderItemEntity.product ? orderItemEntity.product.id : ''}</dd>
          <dt>
            <Translate contentKey="tut3App.orderItem.order">Order</Translate>
          </dt>

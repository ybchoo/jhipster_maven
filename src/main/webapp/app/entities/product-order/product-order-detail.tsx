    ...
    <Row>
      <Col md="8">
        <h2 data-cy="productOrderDetailsHeading">
          <Translate contentKey="tut3App.productOrder.detail.title">ProductOrder</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="placedDate">
              <Translate contentKey="tut3App.productOrder.placedDate">Placed Date</Translate>
            </span>
          </dt>
          <dd>
          ...
          <dt>
            <span id="status">
              <Translate contentKey="tut3App.productOrder.status">Status</Translate>
            </span>
          </dt>
          <dd>{productOrderEntity.status}</dd>
          <dt>
            <span id="code">
              <Translate contentKey="tut3App.productOrder.code">Code</Translate>
            </span>
          </dt>
          <dd>{productOrderEntity.code}</dd>
          <dt>
            <Translate contentKey="tut3App.productOrder.customer">Customer</Translate>
          </dt>

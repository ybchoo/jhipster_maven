...
import com.cyb.domain.Location;
import com.cyb.repository.LocationRepository;
import com.cyb.repository.search.LocationSearchRepository;
import com.cyb.service.dto.LocationDTO;
import com.cyb.service.mapper.LocationMapper;
...
class LocationResourceIT {
     ...
     *
     * @see com.cyb.repository.search.LocationSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    void partialUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.locationId(UPDATED_LOCATION_ID).postalCode(UPDATED_POSTAL_CODE).city(UPDATED_CITY);

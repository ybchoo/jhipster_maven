...
class ProductResourceIT {
    ...
    private static final Sz DEFAULT_SZ = Sz.S;
    private static final Sz UPDATED_SZ = Sz.M;
     ...
     *
     * @see com.cyb.repository.search.ProductSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    void createProduct() throws Exception {
        ...
        assertThat(testProduct.getSz()).isEqualTo(DEFAULT_SZ);
    ...
    @Test
    @Transactional
    void checkSzIsRequired() throws Exception {
        int databaseSizeBeforeTest = productRepository.findAll().size();
        // set the field null
        product.setSz(null);
    ...
    void getAllProducts() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.[*].sz").value(hasItem(DEFAULT_SZ.toString())))
    ...
    void getProduct() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.sz").value(DEFAULT_SZ.toString()))
    ...
    void putNewProduct() throws Exception {
        ...
        assertThat(testProduct.getSz()).isEqualTo(UPDATED_SZ);

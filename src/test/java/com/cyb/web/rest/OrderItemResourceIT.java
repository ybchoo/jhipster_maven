...
import static com.cyb.web.rest.TestUtil.sameNumber;
...
import com.cyb.domain.enumeration.OrderItemStatus;
...
class OrderItemResourceIT {
     ...
     *
     * @see com.cyb.repository.search.OrderItemSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    void searchOrderItem() throws Exception {
        ...
        // Initialize the database
        orderItemRepository.saveAndFlush(orderItem);
        when(mockOrderItemSearchRepository.search("id:" + orderItem.getId(), PageRequest.of(0, 20)))

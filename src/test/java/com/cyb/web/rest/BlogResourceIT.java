...
import com.cyb.domain.Blog;
import com.cyb.repository.BlogRepository;
import com.cyb.repository.search.BlogSearchRepository;
...
class BlogResourceIT {
     ...
     *
     * @see com.cyb.repository.search.BlogSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    void searchBlog() throws Exception {
        ...
        // Initialize the database
        blogRepository.saveAndFlush(blog);
        when(mockBlogSearchRepository.search("id:" + blog.getId())).thenReturn(Stream.of(blog));

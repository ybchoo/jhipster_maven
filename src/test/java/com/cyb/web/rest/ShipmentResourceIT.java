...
import com.cyb.repository.ShipmentRepository;
import com.cyb.repository.search.ShipmentSearchRepository;
...
class ShipmentResourceIT {
     ...
     *
     * @see com.cyb.repository.search.ShipmentSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    void searchShipment() throws Exception {
        ...
        // Initialize the database
        shipmentRepository.saveAndFlush(shipment);
        when(mockShipmentSearchRepository.search("id:" + shipment.getId(), PageRequest.of(0, 20)))

...
import com.cyb.domain.enumeration.OrderStatus;
import com.cyb.repository.ProductOrderRepository;
import com.cyb.repository.search.ProductOrderSearchRepository;
...
class ProductOrderResourceIT {
     ...
     *
     * @see com.cyb.repository.search.ProductOrderSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    void searchProductOrder() throws Exception {
        ...
        // Initialize the database
        productOrderRepository.saveAndFlush(productOrder);
        when(mockProductOrderSearchRepository.search("id:" + productOrder.getId(), PageRequest.of(0, 20)))
